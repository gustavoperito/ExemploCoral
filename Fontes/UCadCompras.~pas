...
type
  TFrmCadCompras = class(TFrmCadObjeto)
...
procedure TFrmCadCompras.BtnNovoClick(Sender: TObject);
begin
  dm.auxiliar.close;
...
procedure TFrmCadCompras.BtnGravarClick(Sender: TObject);
begin
...
procedure TFrmCadCompras.BtnCancelarClick(Sender: TObject);
begin
  CDSCOMPRA.Cancel;
  MedBusca.Text:='';
  inherited;
